					...
					public void mouseClicked(MouseEvent e) {
						if(1 == e.getButton()){
							...
							if(needToSave){
								...
								boolean debugLog = Integer.valueOf((String)commonCfg.get("DebugLog"))>0?true:false;
								int monitorInterval = Integer.valueOf((String)commonCfg.get("DeviceMonitorInterval"))>0?(Integer.valueOf((String)commonCfg.get("DeviceMonitorInterval"))*1000):1000;

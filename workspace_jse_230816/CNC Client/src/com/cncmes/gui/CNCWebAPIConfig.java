...
public class CNCWebAPIConfig extends JDialog {
	...
	private JTextField textFieldSensorCheck;
	...
	private void setCurCommandParas(String...cmdName) {
		...
		String sensorCheck = cncWebAPI.getCmdParaVal(mainKey, curCncOperation, curCncCommand, CncWebAPIItems.SENSORCHECK);
		...
		textFieldSensorCheck.setText(sensorCheck);
...
//				lblRunningMsg.setText("Execute "+curCncCommand+" OK");
				lblRunningMsg.setText("Execute "+curCncCommand+" OK" + ", " + rtnData);
			}else{
//				lblRunningMsg.setText("Execute "+curCncOperation+" OK");
				lblRunningMsg.setText("Execute "+curCncOperation+" OK" + ", " + rtnData);
			}
		}else{
	...
	private CNCWebAPIConfig() {
		...
		int width = 600;
		int height = 600;
		setBounds((d.width - width) / 2, (d.height - height) / 2, 604, 696);
		...
		}
		{
			...
			}
			{
				...
				panelMainCenter.setLayout(gbl_panelMainCenter);
				{
					...
					gbl_panelCfgTop.rowHeights = new int[] {20};
				...
				}
				{
					...
					panelCfgCommon.setLayout(gbl_panelCfgCommon);
					{
						...
						scrollPaneCfgCommon.setEnabled(false);
				...
				}
				{
					...
					gbl_panelCfgLast.columnWidths = new int[]{0, 0, 0, 0, 0};
					gbl_panelCfgLast.rowHeights = new int[] {0};
					gbl_panelCfgLast.columnWeights = new double[]{0.0, 0.0, 0.0, 1.0, Double.MIN_VALUE};
					...
					}
					{
						...
						gbc_textFieldOperator.insets = new Insets(0, 0, 0, 5);
					...
					{
						JLabel lblLchecksensor = new JLabel("Sensor Value");
						GridBagConstraints gbc_lblLchecksensor = new GridBagConstraints();
						gbc_lblLchecksensor.insets = new Insets(0, 0, 0, 5);
						gbc_lblLchecksensor.anchor = GridBagConstraints.WEST;
						gbc_lblLchecksensor.gridx = 2;
						gbc_lblLchecksensor.gridy = 0;
						panelCfgLast.add(lblLchecksensor, gbc_lblLchecksensor);
					}
					{
						textFieldSensorCheck = new JTextField();
						textFieldSensorCheck.setColumns(1);
						GridBagConstraints gbc_textFieldSensorCheck = new GridBagConstraints();
						gbc_textFieldSensorCheck.fill = GridBagConstraints.HORIZONTAL;
						gbc_textFieldSensorCheck.gridx = 3;
						gbc_textFieldSensorCheck.gridy = 0;
						panelCfgLast.add(textFieldSensorCheck, gbc_textFieldSensorCheck);
					}
				}
			}
		}
				...
				btnSaveCommand.addMouseListener(new MouseAdapter() {
					...
					public void mouseClicked(MouseEvent arg0) {
						if(1 == arg0.getButton()){
							...
							String sensorCheck = textFieldSensorCheck.getText().trim();
							...
							cmdInfo.put(CncWebAPIItems.SENSORCHECK, sensorCheck);
							if(!"".equals(inParas)){

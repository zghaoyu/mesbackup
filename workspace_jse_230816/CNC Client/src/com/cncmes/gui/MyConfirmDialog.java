...
public class MyConfirmDialog extends JDialog {
	...
	private MyConfirmDialog() {
		setIconImage(Toolkit.getDefaultToolkit().getImage(MyConfirmDialog.class.getResource("/com/cncmes/img/help.png")));
		...
		contentPanel.setLayout(gbl_contentPanel);
		{
			...
			contentPanel.add(scrollPaneMsg, gbc_scrollPaneMsg);
			{
				...
				txtrMsg.setFont(new Font("Microsoft YaHei UI", Font.PLAIN, 18));

...
//        properties.setProperty("mail.smtp.starttls.enable", "true");// outlook邮箱需要加上
        ...
        try {
            ...
            if(new File("E:/MyDoc/workspace_jse_230816/CNC Client/Log/RobotCMRSocketDataHandler_"+date+".log").exists())
            {
                //attachment body
                MimeBodyPart attch1 = new MimeBodyPart();
                //content add attachment
                msgMultipart.addBodyPart(attch1);
                DataSource dataSource1 = new FileDataSource(new File("E:/MyDoc/workspace_jse_230816/CNC Client/Log/RobotCMRSocketDataHandler_"+date+".log"));
...
//                attch1.setContent("", "text/html;charset=UTF-8");
            ...
            if(new File("E:/MyDoc/workspace_jse_230816/CNC Client/Log/Error_"+date+".log").exists())
            {
                //attachment body
                MimeBodyPart attch2 = new MimeBodyPart();
                //content add attachment
                msgMultipart.addBodyPart(attch2);
                DataSource dataSource2 = new FileDataSource(new File("E:/MyDoc/workspace_jse_230816/CNC Client/Log/Error_"+date+".log"));
...
//                attch2.setContent("", "text/html;charset=UTF-8");
            ...
            if(new File("E:/MyDoc/workspace_jse_230816/CNC Client/Log/Command_10.10.206.178_"+date+".log").exists())
            {
                //attachment body
                MimeBodyPart attch3 = new MimeBodyPart();
                //content add attachment
                msgMultipart.addBodyPart(attch3);
                DataSource dataSource3 = new FileDataSource(new File("E:/MyDoc/workspace_jse_230816/CNC Client/Log/Command_10.10.206.178_"+date+".log"));
...
//                attch3.setContent("", "text/html;charset=UTF-8");
            ...
            if(new File("E:/MyDoc/workspace_jse_230816/CNC Client/Log/Command_10.10.206.72_"+date+".log").exists())
            {
                //attachment body
                MimeBodyPart attch4 = new MimeBodyPart();
                //content add attachment
                msgMultipart.addBodyPart(attch4);
                DataSource dataSource4 = new FileDataSource(new File("E:/MyDoc/workspace_jse_230816/CNC Client/Log/Command_10.10.206.72_"+date+".log"));

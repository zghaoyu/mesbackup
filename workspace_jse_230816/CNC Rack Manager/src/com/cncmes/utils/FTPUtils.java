...
public class FTPUtils {
	 ...
	 */
	public static boolean uploadFile(String localAbsolutePath, String serverFolderName){
		...
		try {
			...
			String fileName = localAbsolutePath.substring(localAbsolutePath.lastIndexOf("/")+1);

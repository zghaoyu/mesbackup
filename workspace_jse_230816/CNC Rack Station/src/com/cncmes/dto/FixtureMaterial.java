...
public class FixtureMaterial {
	...
	public FixtureMaterial(int id, int material_id, int fixture_id, String scan_time, int user_id, String ip_address, String pc_name, int is_released, int is_deleted, String realTableName, int line_id, int rack_id) {
		this.id = id;

    ...
    public void actionPerformed(ActionEvent e) {
        ...
        if(command.equals(statePanel.getBtnSearch().getText()))
        {
            ...
            if(fixtureNo!=null || !fixtureNo.equals(""))
            {
                ...
                {
//                    is_released = 1;
                    fixtureMaterials = searchFixtureMaterial(fixtureNo,0,0,statePanel.getCncLine().getId(),statePanel.getRack().getId());
                    fixtureMaterials.addAll(searchFixtureMaterial(fixtureNo,1,1,statePanel.getCncLine().getId(),statePanel.getRack().getId()));
                }

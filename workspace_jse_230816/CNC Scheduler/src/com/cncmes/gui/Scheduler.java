...
public class Scheduler extends JFrame {
	...
	private Scheduler() {
		...
		comboBoxMachineLineName.setModel(new DefaultComboBoxModel<String>(new String[] {"All", "TS61A", "TS62A", "TS6HF01"}));
		...
		comboBoxWorkerLineName.setModel(new DefaultComboBoxModel<String>(new String[] {"All", "TS61A", "TS62A", "TS6HF01"}));
		...
		comboBoxMaterialLineName.setModel(new DefaultComboBoxModel<String>(new String[] {"All", "TS61A", "TS62A", "TS6HF01"}));
		...
		comboBoxStatisticLineName.setModel(new DefaultComboBoxModel<String>(new String[] {"All", "TS61A", "TS62A",  "TS6HF01"}));

...
public class CNCMaterial {
	...
	public String toString() {
		return "CNCMaterial [id=" + id + ", material_no=" + material_no + ", processcard_id=" + processcard_id
				+ ", user_id=" + user_id + ", ip_address=" + ip_address + ", pc_name=" + pc_name + ", create_time="
				+ create_time + ", is_delete=" + is_delete + ", realTableName=" + realTableName + "]";
	}

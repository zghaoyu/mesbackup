...
public class LogUtils {
	...
	public static boolean imgProcLog(String logDir, String fileName, String logContent){
		boolean ok = true;
		MyFileUtils.makeFolder(logDir);
		
		String localPath = logDir + File.separator + fileName;
		File file = new File(localPath);
		try {
			PrintStream ps = new PrintStream(new FileOutputStream(file, true));
			ps.append(logContent);

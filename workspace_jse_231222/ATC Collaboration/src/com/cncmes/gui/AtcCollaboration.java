...
//        setResizable(false);
        ...
        this.addWindowListener(new WindowAdapter(){
            public void windowClosing(WindowEvent e){
                int rtn = JOptionPane.showConfirmDialog(atcCollaboration.getContentPane(), "Run the ATC Collaboration Module in background", "Minimize", JOptionPane.YES_NO_OPTION);
                if(0 == rtn){
...
//                            refreshGUI(i);
//                        }
                        msgArea.append(RunningMsgUtil.runningMsgFormat("test"));

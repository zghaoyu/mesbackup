...
public class IRobotFactory {
	...
	/**
	 * Factory to Create IRobot Controller
	 * 
	 * 2021.10.26
	 */
	...
	/**
	 * @param driver
	 *            - specify the driver class path or dll name to be loaded
	 * @return null when fail to load the driver
	 */
	@SuppressWarnings({ "rawtypes", "unchecked" })
	public static IRobot getInstance(String driver) {
		IRobot ctrl = null;
		Class clazz = null;
		Method method = null;
		try {

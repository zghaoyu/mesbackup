...
public class RobotCMR implements IRobot {
	...
	@Override
	public ArrayList<Object> pickAndPlace(String ip, String pickFromPose, String placeToPose) {
//		System.out.println(pickFromPose+"-----------"+placeToPose);
	...
	@Override
	public String scanBarcode(String ip) {
		ArrayList<Object> rtn = this.execute_cmd(ip,"read_barcode",10);
		if((boolean)rtn.get(0)){
//			System.out.println((String)rtn.get(1));

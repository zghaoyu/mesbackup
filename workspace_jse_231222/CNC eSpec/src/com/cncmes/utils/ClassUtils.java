...
public class ClassUtils {
	...
	/**
	 * 
	 * @param className the full name space of the target class
	 * @param constructor the method name of creating the object
	 * @return the instance of the specific class
	 */
	public static Object getObjectByClassName(String className, String constructor){
		Object obj = null;
		Class clazz = null;
		Method method = null;
		...
		try {
			...
			if(null!=constructor && !"".equals(constructor)){
				method = clazz.getMethod(constructor);

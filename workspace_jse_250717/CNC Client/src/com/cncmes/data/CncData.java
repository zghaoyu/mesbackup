...
public final class CncData extends RunningData<CncItems> implements DeviceSubject {
	private final int WKZONEQTY = 14;    //6
	...
	public String getDataForObservers(String machineIP){
		...
		System.out.println("at CncData.getDataForObservers info : "+info);
		return info;
	}
	...
	public synchronized void setCncState(String ip, DeviceState devState, boolean threadMode,boolean threadSequential,boolean theLastThread, boolean forceUpdate){
		...
		if(DeviceState.ALARMING == devState){
			...
			setCncLastState(ip, devState);	//devState = ALARMING
		}
...
//		for(int i=1; i<=workzoneQty; i++){    //2024.10.21 cnc have 14 slots now and if use variable workzoneQty ,workzoneQty = CncConfig.xml capacity
		for(int i=1; i<=14; i++){
...
//		System.out.println("qty:"+qty+"    WORKZONEQTY:"+WKZONEQTY);
	...
	public String[] getEmptyWorkzones(String ip){
		...
		System.out.println("at CncData.getEmptyWorkzones cncEmptyWorkzones:"+ Arrays.deepToString(workzones));
	...
	public void clearMachiningData(String ip){
		...
		setData(ip, CncItems.D_WPID_ZN7,"");
		setData(ip, CncItems.D_WPID_ZN8,"");
		setData(ip, CncItems.D_WPID_ZN9,"");
		setData(ip, CncItems.D_WPID_ZN10,"");
		setData(ip, CncItems.D_WPID_ZN11,"");
		setData(ip, CncItems.D_WPID_ZN12,"");
		setData(ip, CncItems.D_WPID_ZN13,"");
		setData(ip, CncItems.D_WPID_ZN14,"");

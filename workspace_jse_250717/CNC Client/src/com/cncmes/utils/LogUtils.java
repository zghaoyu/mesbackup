...
public class LogUtils {
	...
	public static boolean ATCandCNCLog(String ip,String logContent){
		boolean ok = true;
		String localPath = getLogFolder() + File.separator + ip +"_CNCandATC_collaboration" + TimeUtils.getCurrentDate("yyyyMMdd")+".log";
		File file = new File(localPath);
		try {
			logContent = TimeUtils.getCurrentDate("yyyy-MM-dd HH:mm:ss") + separator + System.currentTimeMillis() + separator + logContent;
			PrintStream ps = new PrintStream(new FileOutputStream(file, true));
	...
	public static boolean fiveAspectLog(String ip,String logContent){
		boolean ok = true;
		String localPath = getLogFolder() + File.separator + ip +"_FiveAspectMachining_" + TimeUtils.getCurrentDate("yyyyMMdd")+".log";
		File file = new File(localPath);
		try {
			logContent = TimeUtils.getCurrentDate("yyyy-MM-dd HH:mm:ss") + separator + System.currentTimeMillis() + separator + logContent;
			PrintStream ps = new PrintStream(new FileOutputStream(file, true));
